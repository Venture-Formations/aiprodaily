...
export const ARTICLE_MODULE_COLS = `id, publication_id, name, display_order, is_active, show_name, selection_mode, block_order, config, articles_count, lookback_hours, ai_image_prompt, created_at, updated_at`
