      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Master AI Tools, Prompts & News **in Just 3 Minutes a Day**"
            className="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <p className="text-xs text-gray-400 mt-1">Wrap text in **double asterisks** to apply the gradient underline style.</p>
        </div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="One Last Step! **Personalize Your Experience**"
            className="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <p className="text-xs text-gray-400 mt-1">Wrap text in **double asterisks** to apply the gradient underline style.</p>
        </div>
