...
export default function PromptModuleSettings({
  module,
  onUpdate,
  onDelete
}: PromptModuleSettingsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <select
          value={localModule.selection_mode}
          onChange={(e) => handleSelectionModeChange(e.target.value as PromptSelectionMode)}
          disabled={saving}
        ...
        <p className="text-xs text-gray-500">
          {SELECTION_MODE_DESCRIPTIONS[localModule.selection_mode]}
        </p>
      </div>

      {/* Info Box based on selection mode */}
      ...
      <div className="space-y-4">
        <PromptBlockOrderEditor
          blockOrder={localModule.block_order as PromptBlockType[]}
      ...
      <div className="border border-red-200 rounded-lg overflow-hidden mt-8">
        <div className="p-4 bg-red-50">
          ...
          <p className="text-sm text-red-600 mt-1">
            Deleting this prompt section will remove it from all future issues.
          </p>
        </div>
