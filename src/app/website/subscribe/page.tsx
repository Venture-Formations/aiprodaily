        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="font-display text-2xl tracking-tight text-slate-900 sm:text-4xl">
              If you're an accountant… AI isn't replacing you.
              <br />
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Accountants using AI are.</span>
              </span>
            </h1>

            {/* Subheadline */}
            <p className="mt-4 sm:mt-6 text-base sm:text-lg tracking-tight text-slate-700">
              Don't have time to keep up with AI? Neither do 10k+ other accountants.
              That's why they read this. 3 minutes. No hype.
            </p>
