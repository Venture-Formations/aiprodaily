...
export default async function BillingPage() {
  ...
  return (
    <div>
      ...
      {/* Billing Portal Card */}
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center max-w-xl mx-auto">
        <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r from-[#a855f7]/10 via-[#06b6d4]/10 to-[#14b8a6]/10 flex items-center justify-center">
          <CreditCard className="w-8 h-8 text-[#06b6d4]" />
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-[#1c293d] text-white rounded-xl font-semibold hover:bg-[#1c293d]/90 transition-colors"
        >
          Open Billing Portal
          ...
          <div className="grid grid-cols-3 gap-4 text-left">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Update card info</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0">
