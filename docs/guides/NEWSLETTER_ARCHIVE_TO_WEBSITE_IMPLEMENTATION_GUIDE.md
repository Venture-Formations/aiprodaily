...
**File:** Create migration in `db/migrations/` (or your Supabase migrations folder)

```sql
-- db/migrations/create_archived_newsletters.sql
...
psql $DATABASE_URL -f db/migrations/create_archived_newsletters.sql
```
